...
export class PostsList extends React.Component {
  ...
  PostsListToPostsItems = (posts) => {
    ...
    return <PostsItem key={key} preview={preview} name={name} description={description} source={source} date={date} isvideo={isvideo} lang={lang} currentlanguage={currentlanguage}/>;
  };
